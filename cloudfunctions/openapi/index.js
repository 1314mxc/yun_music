// 云函数入口文件
import { init, getWXContext, openapi, uploadFile, getOpenData as _getOpenData } from 'wx-server-sdk'
...
async function sendSubscribeMessage(event) {
  ...
  const sendResult = await openapi.subscribeMessage.send({
    touser: OPENID,
    templateId,
...
async function getWXACode(event) {
  ...
  const wxacodeResult = await openapi.wxacode.get({
